...
export const metadata: Metadata = {
    title: 'Jasim Uddin - Frontend Engineer Portfolio | Bangladesh',
    description:
        'Welcome to the portfolio of Jasim Uddin, a passionate Frontend Engineer from Bangladesh with 4 years of experience. Explore my projects and expertise!',
};
